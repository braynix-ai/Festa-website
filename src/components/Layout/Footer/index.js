const navigation = {
  solutions: [
    { name: "About Festa", href: "/about" },
    { name: "Featues", href: "/#manage" },
    {
  ...
  support: [
    ...
    { name: "Register with us", href: "https:///partner.festabash.com" },
    {
...
export default function Footer() {
  return (
    <footer
      className="bg-black bg-opacity-50 border-t mt-10"
